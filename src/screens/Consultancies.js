...
export default function ({ navigation }) {
  ...
  const getFoldersData = async () => {
    ...
    await axios.post('http://192.168.136.158:3002/getFoldersData', data, {
      headers: {
  ...
  const downloadScreen = async () => {
    ...
    await axios.post("http://192.168.136.158:3002/downloadFolder", data, {
      headers: {
        'Content-Type': 'application/json'
      },
  ...
  const deleteScreen = async () => {
    ...
    await axios.post("http://192.168.136.158:3002/deleteFile", data, {
      headers: {
        'Content-Type': 'application/json'
      },
    }).then(async response => {
  ...
  const playScreen = async (nameScreen) => {
    ...
    await axios.post("http://192.168.136.158:3002/fileUrl", data, {
      headers: {
        'Content-Type': 'application/json'
      },
    }).then(async response => {
